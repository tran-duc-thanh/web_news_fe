...
<template>
    <div v-if="isVisible" class="popup">
        <div class="popup-content">
            <!-- Nội dung của popup -->
            <H4>{{ popupContent }}</H4>
            <input type="text" v-model="name" style="margin-right: 10px;" placeholder="Tên thể loại" />
            <input type="text" v-model="code" style="margin-right: 10px;" placeholder="Mã thể loại" />
